...
# Provide the path to the folder containing frames and output paths
frames_folder = "/home/alireza/CG_Simulation/Phase1_Capturing/Kombat_Washington/captured_frames"  # Input frames folder
output_file = "myframes_kombat2.txt"              # Output log file to store QR data
output_folder = "/home/alireza/CG_Simulation/Phase2_Ordering/Processed_Frames_kombat2"  # Folder to save processed images
